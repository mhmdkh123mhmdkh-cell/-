    ...
    <section id="about" className="py-20 md:py-28 bg-[#C7DDE8]">
      <div className="editorial-shell">
        <div className="bg-[#102F49] border border-[#2A526A] rounded-[3px] p-8 sm:p-14 lg:p-16 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-[3px] bg-[#102F49] text-[#FFFFFF] border-2 border-[#1677B7] flex items-center justify-center text-4xl sm:text-5xl font-extrabold shrink-0 shadow-xs">
            {t.about.mark}
          </div>
          ...
          <div className="space-y-3 text-center md:text-start flex-1">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#FFFFFF] tracking-tight leading-snug">
              {t.about.text}
            </p>
          </div>
        </div>
